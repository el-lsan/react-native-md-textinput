...
export default class TextField extends Component {
  ...
  render() {
    ...
    return (
      <View style={[dense ? styles.denseWrapper : styles.wrapper, this.state.height ? {height: this.state.height}: {}, wrapperStyle]} ref="wrapper">
        <TextInput
...
const styles = StyleSheet.create({
  ...
  textInput: {
    fontSize: 16,
    height: Platform.select({android: 40, ios: 34}),
    lineHeight: 34,
